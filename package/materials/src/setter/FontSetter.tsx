...
const FontAlignOptions: SelectProps["options"] = [
  "left",
  "right",
  "center",
  "justify",
...
const FontWeightOptions: SelectProps["options"] = [
  "weight",
  "bold",
  "lighter",
  "bolder",
  ...
  return (
    <Collapse.Panel {...props} key="fontSetter" header="排版" showArrow={false}>
      <Form.Item
        ...
        name={["style", "fontSize"]}
      >
        <Slider min={10} max={88} />
      </Form.Item>
      <Row gutter={20}>
        <Col span={12}>
          <Form.Item
            label="字体排列"
            tooltip="字体排列，对应CSS中的text-align属性"
          >
            <Select
              placeholder="请选择字体排列方式"
